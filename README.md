...
### Introduction
This is a list of categorized domains, with additional entries for wildcard blocking.  The domains are documented, as to keep a track of what is being blocked or allowed.  The primary focus is to **guarantee** not to break any useful services or legitimate websites.  Each domain is only added after through research and tests in order to make sure it should _intentionally be blocked_.

### Sources
The domain entries on this list are hand-picked, and mainly added by analyzing what the traffic generated by the devices that I use.  I intend to focus on _both_ websites and mobile domains.  This will include the obvious pop-ups and pop-unders, frame ads, 3<sup>rd</sup> party image and video ads, mobile in-app banners -- as well as hidden tracking and other unnecessary bloated spyware that is ususally bundled with common apps that are downloaded, and the websites you visit.
